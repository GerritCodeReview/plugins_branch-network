 ...
 * a canvas ID */
NetworkCanvas = function(canvasid, width, height, names_width, meta, data, commitUrlTemplate, networkUrl, metaUrl, dataUrl, locationInsteadOfPopup) {
	...
	this.locationInsteadOfPopup = locationInsteadOfPopup || false;
...
NetworkCanvas.Mouse = function(c) {
	...
	this.goTo = function(url) {
		if (parnt.canvas.locationInsteadOfPopup) {
